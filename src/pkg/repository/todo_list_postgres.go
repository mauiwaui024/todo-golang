...
func (r *TodoListPostgres) Create(userId int, list todo.TodoList) (int, error) {
	//два запроса-транзакция
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
	var id int
	//пишем запрос для создания записи таблицы в туду
...
func (r *TodoListPostgres) GetAll(userId int) ([]todo.TodoList, error) {
	...
	//команда inner join помогает выбрать те записи которые имеет одинаковые значения в обеих таблицах
